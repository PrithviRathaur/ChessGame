/**
* Represents a Rook that is a piece on a chess board.
*
* @author prathaur3
*
* @version 1.0
...
public class Rook extends Piece {
    ...
    private static int[][] moveChange = {{-1, 0}, {0, -1},
        {0, 1}, {1, 0}};
    ...
    */
    ...
    /**
    * @return the Rook's algebraic name
    */
    @Override
    ...
    /**
    * @return the Rook's fen notation name
    */
    @Override
    ...
    /**
    * @return the squares this Rook could move to
    */
    @Override
